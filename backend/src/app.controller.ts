...
export class AppController {
  constructor(
    ...
    this.db.setUser(
      ...
      .then((tmp) => this.db.sendFriendReq('upeyret', 'jiglesia'))
      .then((tmp) => this.db.sendFriendReq('upeyret', 'mravily'))
      .then((tmp) => this.db.sendFriendReq('upeyret', 'adesvall'))
      .then((tmp) => this.db.sendFriendReq('mravily', 'jiglesia'))
      .then((tmp) => this.db.sendFriendReq('mravily', 'adesvall'))
      .then((tmp) => this.db.sendFriendReq('adesvall', 'jiglesia'))
      .then((tmp) => {
